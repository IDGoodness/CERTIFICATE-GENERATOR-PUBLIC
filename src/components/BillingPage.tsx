    ...
    try {
      ...
      const defaultPlans = {
        premium_monthly: {
          ...
          price: 500000, // ₦5,000 NGN (500000 kobo)
          currency: 'NGN',
          duration: 30,
          features: [
            'Custom Templates',
        ...
        premium_yearly: {
          name: 'Premium Yearly',
          price: 5000000, // ₦50,000 NGN (5000000 kobo) - 2 months free bonus!
          currency: 'NGN',
          duration: 365,
          features: [
  ...
  const initiatePayment = async (planId: string) => {
    ...
    try {
      ...
      if (data.authorizationUrl) {
        ...
        toast.error('Payment initialization succeeded but no payment URL received');
      }
    } catch (error: any) {
